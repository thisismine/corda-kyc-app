    ...
    public static class Initiator extends FlowLogic<KYCFlowResult>
    {
        ...
        public KYCFlowResult call()
        {
            ...
            try {
                ...
                return new KYCFlowResult.Success(String.format("Transaction id %s committed to ledger.", signWithB.getId()));
    ...
    public static class Acceptor extends FlowLogic<KYCFlowResult>
    {
        ...
        public KYCFlowResult call()
        {
            try {
                ...
                return new KYCFlowResult.Success(String.format("Signed And Sent Back"));
